...
function ContactButton({
  ...
  return (
    <a href={link} target="_blank" className="block ">
      <button
        className={`${textColor} ${hoverBgColor} bg-white relative w-8 h-8 rounded-xl flex items-center justify-center shadow-md transition-all duration-300 cursor-pointer hover:text-white`}
      >
        <svg
          width="22"
          height="22"
...
function CountButton({ name }: { name: string }) {
  return (
    <div className="relative w-10 h-15 bg-transparent flex flex-col justify-center items-center group">
  ...
  return (
    <>
      ...
      <div className=" bg-transparent min-h-screen w-full">
        <div className="relative bg-white/80 w-50 h-75 top-5 left-3 rounded-md flex flex-col items-center fixed">
          <div className="relative top-5 w-22 h-22 rounded-full shadow-xl overflow-hidden bg-gray-200">
            {/* 头像 */}
            <Image
              src="/TouXiang.jpg"
              alt="Profile Picture"
          ...
          <h1 className="relative top-5 text-4xl font-black text-[#A1F7BF] tracking-tight">
            Zoolin
          </h1>
          <div className="relative top-8 flex justify-evenly sm:justify-center sm:gap-8  w-full ">
            <ContactButton
          ...
          <div className="relative flex justify-center items-center bg-transparent w-50 h-20 gap-6 top-12">
            <CountButton name="文章" />
            <CountButton name="类型" />
            <CountButton name="标签" />
          </div>
        ...
        {/*目录 */}
        <div className="relative bg-white/80 w-50 h-100 top-5 left-3 rounded-md flex flex-col items-center fixed"></div>
      </div>
    </>
  );
}
